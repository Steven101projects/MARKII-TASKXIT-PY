  ...
  return (
    <div className="flex justify-between w-[90vw] h-12 mb-4">
      <button
        ...
        p-2 w-1/2 mx-2 hover:scale-105 transition-transform"
      >
        Reminders
      </button>
...
export default function BlueBoard({ isBoardEditing }) {
  ...
  const desktopView = (
    ...
    >
      <SideNotes
        className="absolute -left-9 rounded-e-xl text-right pr-4
        transform translate-x-0 hover:translate-x-4 transition-transform duration-300"
      />

      <BoardNote isEditing={isBoardEditing} />

      <SideNotes
        className="absolute right-0 rounded-s-xl hover:w-56
